"""
ai_analyzer.py
Uses Groq API (Llama 3) to generate plain-English explanation and Python conversion of COBOL code.
...
def _call_gemini(prompt: str) -> str:
    """Call Groq API (Llama 3) and return text response."""
